/**************************************************************************
 Program:  NSP_fcl_sale_2009q1_address.sas
 Library:  DHCD
 ...
 Description:  Foreclosure sales in 2009-Q1 
 by property type for NSP census tracts.
...
data NSP_forecl_address;
  ...
  where report_dt = '01jan2009'd and foreclosure_sale and
        put( geo2000, $nbrhd. ) ~= '';
...
ods tagsets.excelxp file="D:\DCData\Libraries\DHCD\Prog\NSP_fcl_sale_2009q1_address.xls" style=minimal
      options( sheet_interval='page' );

ods listing close;

ods tagsets.excelxp options( sheet_name="Foreclosure sales 2009-Q1");
