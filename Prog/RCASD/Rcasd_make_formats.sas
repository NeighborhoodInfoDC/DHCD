...
proc format library=DHCD;
  ...
  value $rcasd_notice_type
    ...
    "127" = "Election request for condominium conversion"
    ...
    "154" = 'Conversion - Not a Housing Accommodation Exemption Application - SFD Letter to Landlord'
    "155" = 'Conversion - Warranty Claim - Complaint (TOPA)'
    "156" = "Conversion - Warranty Security Bond - SFD Letter to Landlord"
    ...
    "238" = "Right of first refusal & tenant waiver of right to purchase"
    ...
    "252" = "Notice of intent to file a petition for relief (notice of transfer)"
    "253" = "Petition for declaratory relief and request (T/A)"
    ...
    "292" = "Cooperative conversion registration application"
