...
proc format library=DHCD;
  ...
  value $rcasd_text2type 
    ...
    "TENANTASSOCIATIONREGISTRATIONS" = "207"
    
    "OFFEROFSALENOTICES-SINGLEFAMILY", 
    "SINGLEFAMILYDWELLINGOFFERSOFSALE", 
    "OFFEROFSALE(SINGLEFAMILYRENTAL)",
    "OFFERSOFSALE:SFD/COOP-CONDOUNIT",
    "OFFEROFSALENOTICES(SINGLEFAMILY)" = "208"
    
    "OFFEROFSALENOTICES-2TO4UNITS", 
    "2-4RENTALUNITOFFERSOFSALE", 
    "OFFEROFSALE(2-4RENTALUNITS)", 
    "OFFERSOFSALE:2-4UNITS",
    "OFFEROFSALENOTICES(2-4RENTALUNITS)",
    "OFFEROFSALENOTICE(2-4)" = "209"
    
    "OFFEROFSALENOTICES-5+UNITS", 
    "5+RENTALUNITOFFERSOFSALE", 
    "OFFEROFSALE(5ORMORERENTAL)",
    "OFFERSOFSALE:5+UNITS",
    "OFFEROFSALENOTICES(5ORMORERENTALUNITS)",
    "OFFEROFSALENOTICES(5ORMORE)",
    "OFFEROFSALENOTICE(5+)" = "210"
    ...
    "SFDOFFEROFSALEW/CONTRACT",
    "OFFEROFSALEW/CONTRACT(SFD)" = "220"
    
    "SINGLEFAMILYDWELLINGOFFERSOFSALEW/OCONTRACT",
    "SFDOFFEROFSALEW/OCONTRACT",
    "OFFEROFSALEW/OCONTRACT(SFD)" = "221"
    
    "2-4UNITSOFFEROFSALEW/CONTRACT", 
    "OFFEROFSALEW/CONTRACT(2-4)" = "224"
    ...
    "5+UNITSOFFEROFSALEW/OCONTRACT",
    "OFFEROFSALEW/OCONTRACT(5+)" = "229"
